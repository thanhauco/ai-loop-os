...
export const loopOrder: Array<{ name: LoopName; title: string }> = [
  ...
  { name: "routing", title: "Routing Loop" },
  { name: "research", title: "Research Loop" },
  { name: "tool_selection", title: "Tool Selection Loop" },
  { name: "coding", title: "Coding Loop" },
  { name: "evaluation", title: "Evaluation Loop" },
  { name: "critic", title: "Critic Loop" },
  { name: "verification", title: "Verification Loop" },
  { name: "simulation", title: "Simulation Loop" },
  ...
  { name: "cost", title: "Cost Loop" },
  { name: "latency", title: "Latency Loop" },
  { name: "multi_agent_debate", title: "Multi-Agent Debate Loop" },
  { name: "human_approval", title: "Human Approval Loop" },
  { name: "knowledge_graph", title: "Knowledge Graph Loop" },
  { name: "learning", title: "Learning Loop" },
